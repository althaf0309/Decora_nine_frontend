...
const SERVICE_FAQ: QA[] = [
  ...
  { q: 'How long does an interior project take?', a: 'Timelines vary with the size and scope of the work, but on-schedule delivery is one of our commitments. As a general guide, we hand over most home interiors within 30 days, cafés and restaurants within 15 days, and office interiors within 30–45 days. Because our supervisors and craftsmen work in-house, we keep every project true to schedule — from the first drawing to the final finish.' },
